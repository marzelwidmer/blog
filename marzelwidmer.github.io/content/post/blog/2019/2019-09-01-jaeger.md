...
![jaeger-query-ui.png](../images/jaeger/jaeger-query-ui.png)
...
Deploy [CustomResourceDefinition](../images/deploy/jaegertracing_v1_jaeger_crd.yaml){:target="_blank"} for the `apiVersion: jaegertracing.io/v1`
[ServiceAccount](../images/jaeger/deploy/service_account.yaml){:target="_blank"} [ClusterRole](../images/jaeger/deploy/role.yaml){:target="_blank"} 
[ClusterRoleBinding](../images/jaeger/deploy/role_binding.yaml){:target="_blank"} [Operator](../images//jaeger/deploy/operator.yaml){:target="_blank"}
...
![OAuth](../images/jaeger/OAuth.png)
![jaeger-collector-ui](../images/jaeger/jaeger-collector-ui.png)
